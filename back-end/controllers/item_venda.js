...
const {ItemVenda, Venda, Produto} = require('../models')
...
controller.retrieve = async (req, res) => {
    try {
        const data = await ItemVenda.findAll({
            include: [
...
controller.retrieveOne = async (req, res) => {
    try {
        const data = await ItemVenda.findByPk(req.params.id)
...
controller.update = async (req,res) => {
    try {
        const response = await ItemVenda.update(
            req.body,
...
controller.delete = async (req, res) => {
    try {
        const response = await ItemVenda.destroy(
            { where: {id: req.params.id} }
        )
