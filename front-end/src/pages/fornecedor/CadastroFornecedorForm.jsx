...
export default function CadastroFornecedoresForm() {
  ...
  async function sendData() {
    ...
    try {
      ...
      if (params.id) await myfetch.put(`${API_PATH}/${params.id}`, fornecedor)

      // Registro não existe: chama POST para criar
      else await myfetch.post(API_PATH, fornecedor)
  ...
  return (
    <>
      ...
      <SectionTitle title={params.id ? "Editar fornecedor" : "Cadastrar novo fornecedor"} />
